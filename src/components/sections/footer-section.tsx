    ...
    <footer className="relative bg-background px-6 py-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-end">
          <div>
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Анна <em className="italic">&</em><br />Михаил
            </motion.h2>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <p className="text-muted-foreground text-sm mb-4">Оставьте пожелание молодожёнам ✨</p>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">14 июня 2025 · Анна & Михаил</p>
          <p className="text-muted-foreground text-sm italic font-serif">С любовью ждём вас 🤍</p>
        </div>
      </div>
    </footer>
  )
